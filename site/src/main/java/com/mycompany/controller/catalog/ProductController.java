...
/**
 * This class works in combination with the ProductHandlerMapping which finds a
 * product based upon the passed in URL.
 */
@Controller
...
public class ProductController extends BroadleafProductController {
	...
	public String search(Model model, HttpServletRequest request,
		...
		System.out.println("Get product on menufactuere part");
