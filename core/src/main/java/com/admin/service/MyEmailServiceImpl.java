...
public class MyEmailServiceImpl implements MyEmailWebService
		 {
	...
	public void sendOrderConfirmation(Date orderDate, String orderId,
		...
		emailService.sendTemplateEmail(emailAddress,
				getOrderConfirmationEmailInfo(), props);
	}

	// Method based injection because we need to reference prototype scoped
	// beans in a singleton bean
