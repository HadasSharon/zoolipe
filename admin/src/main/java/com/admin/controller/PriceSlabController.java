...
@Controller
@RequestMapping("/" + PriceSlabController.SECTION_KEY)
public class PriceSlabController extends AdminAbstractController {

	protected static final String SECTION_KEY = "priceSlab";
	...
	public String getSearchWindow(HttpServletRequest request,
		...
		model.addAttribute("customView",
				"views/priceSlab/searchPriceSlab");
	...
	@RequestMapping(value = "/getPriceSlabForEdit", method = RequestMethod.GET)
	public String getProductCatalogForEdit(HttpServletRequest request,
			HttpServletResponse response, Model model,
			@RequestParam("id") Long id) throws Exception {
		model.addAttribute("customView",
				"views/priceSlab/editPriceSlab");
		List<SupplierCatalog> supplierCatalogsList = adminService
				.getSuplierCatalogOnProductId( id);
		
		model.addAttribute("productCatalog", supplierCatalogsList);
